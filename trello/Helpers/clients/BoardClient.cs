...
namespace trello.Helpers
{
    public static class BoardClient
    {
        ...
        {
            var finalUrl = string.Format(Constants.DeleteBoard, id);
        ...
        {
            var createUrl = string.Format(Constants.CreateBoard, board.Name, board.Desc, board.Closed);
        ...
        {
            return client.Execute(new RestRequest(Constants.GetBoards, Method.GET));
        }
